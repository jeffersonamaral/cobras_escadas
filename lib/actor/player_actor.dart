import 'package:cobras_escadas/model/player.dart';
import 'package:cobras_escadas/util/contants.dart';
...
class PlayerActor extends AbstractActor {
  ...
  PlayerActor({ required Player player, required SpriteComponent component, required TextComponent nameComponent,
    required List<SpriteAnimationComponent> animationComponents, double animationPositionOffset = 0, Paint? paint }) : super(component, paint) {
    this._player = player;
